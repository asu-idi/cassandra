...
public class LeveledManifest
{
    ...
    {
        return maxBytesForLevel(level, maxSSTableSizeInBytes, levelFanoutSize);
    }

    public static long maxBytesForLevel(int level, long maxSSTableSizeInBytes, int levelFanoutSize)
    {
        if (level == 0)
